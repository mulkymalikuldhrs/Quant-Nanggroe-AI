...
try:
    ...
    class Hand:
        ...
        @property
        def agent_count(self) -> int: return 0
        @property
        def max_replicas(self) -> int: return 10
        def add_agent(self, agent_id: str) -> None: pass
        def remove_agent(self, agent_id: str) -> None: pass
    
    class HandManager:
        """Stub hand manager — real implementation in engine.colony.hands."""
        def __init__(self, *args, **kwargs): pass
        def get_hand(self, hand_type) -> Hand: return Hand()
        def get_all_status(self) -> Dict[str, Dict]: return {}
        def get_available_hands(self) -> List[Hand]: return [Hand()]
        def assign_agent(self, hand_type, agent_id: str) -> None: pass
