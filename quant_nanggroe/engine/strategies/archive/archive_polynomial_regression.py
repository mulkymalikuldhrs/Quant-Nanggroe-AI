"""Archive wrapper for polynomial_regression — restored from pre-consolidation."""
...
class ArchivePolynomialRegressionStrategy(Strategy):
    """Archive wrapper for polynomial_regression strategy (pre-consolidation)."""

    name = "archive_polynomial_regression"
    description = "Archive wrapper for polynomial_regression (pre-consolidation)"
