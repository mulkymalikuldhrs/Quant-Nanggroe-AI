"""Archive wrapper for value_factor — restored from pre-consolidation."""
...
class ArchiveValueFactorStrategy(Strategy):
    """Archive wrapper for value_factor strategy (pre-consolidation)."""

    name = "archive_value_factor"
    description = "Archive wrapper for value_factor (pre-consolidation)"
