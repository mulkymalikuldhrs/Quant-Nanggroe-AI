"""Archive wrapper for mfi_strategy — restored from pre-consolidation."""
...
class ArchiveMfiStrategyStrategy(Strategy):
    """Archive wrapper for mfi_strategy strategy (pre-consolidation)."""

    name = "archive_mfi_strategy"
    description = "Archive wrapper for mfi_strategy (pre-consolidation)"
