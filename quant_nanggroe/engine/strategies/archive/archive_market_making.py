"""Archive wrapper for market_making — restored from pre-consolidation."""
...
class ArchiveMarketMakingStrategy(Strategy):
    """Archive wrapper for market_making strategy (pre-consolidation)."""

    name = "archive_market_making"
    description = "Archive wrapper for market_making (pre-consolidation)"
