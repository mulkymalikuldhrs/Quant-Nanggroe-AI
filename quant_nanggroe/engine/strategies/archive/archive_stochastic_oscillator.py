"""Archive wrapper for stochastic_oscillator — restored from pre-consolidation."""
...
class ArchiveStochasticOscillatorStrategy(Strategy):
    """Archive wrapper for stochastic_oscillator strategy (pre-consolidation)."""

    name = "archive_stochastic_oscillator"
    description = "Archive wrapper for stochastic_oscillator (pre-consolidation)"
