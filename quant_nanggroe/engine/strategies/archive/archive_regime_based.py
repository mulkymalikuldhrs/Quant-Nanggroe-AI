"""Archive wrapper for regime_based — restored from pre-consolidation."""
...
class ArchiveRegimeBasedStrategy(Strategy):
    """Archive wrapper for regime_based strategy (pre-consolidation)."""

    name = "archive_regime_based"
    description = "Archive wrapper for regime_based (pre-consolidation)"
