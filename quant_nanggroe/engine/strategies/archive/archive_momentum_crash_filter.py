"""Archive wrapper for momentum_crash_filter — restored from pre-consolidation."""
...
class ArchiveMomentumCrashFilterStrategy(Strategy):
    """Archive wrapper for momentum_crash_filter strategy (pre-consolidation)."""

    name = "archive_momentum_crash_filter"
    description = "Archive wrapper for momentum_crash_filter (pre-consolidation)"
