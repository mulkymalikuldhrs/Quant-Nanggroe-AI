"""Archive wrapper for social_sentiment — restored from pre-consolidation."""
...
class ArchiveSocialSentimentStrategy(Strategy):
    """Archive wrapper for social_sentiment strategy (pre-consolidation)."""

    name = "archive_social_sentiment"
    description = "Archive wrapper for social_sentiment (pre-consolidation)"
