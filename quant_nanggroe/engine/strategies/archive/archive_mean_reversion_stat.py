"""Archive wrapper for mean_reversion_stat — restored from pre-consolidation."""
...
class ArchiveMeanReversionStatStrategy(Strategy):
    """Archive wrapper for mean_reversion_stat strategy (pre-consolidation)."""

    name = "archive_mean_reversion_stat"
    description = "Archive wrapper for mean_reversion_stat (pre-consolidation)"
