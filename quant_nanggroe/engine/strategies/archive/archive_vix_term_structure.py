"""Archive wrapper for vix_term_structure — restored from pre-consolidation."""
...
class ArchiveVixTermStructureStrategy(Strategy):
    """Archive wrapper for vix_term_structure strategy (pre-consolidation)."""

    name = "archive_vix_term_structure"
    description = "Archive wrapper for vix_term_structure (pre-consolidation)"
