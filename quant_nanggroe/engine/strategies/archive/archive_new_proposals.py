"""Archive wrapper for new_proposals — restored from pre-consolidation."""
...
class ArchiveNewProposalsStrategy(Strategy):
    """Archive wrapper for new_proposals strategy (pre-consolidation)."""

    name = "archive_new_proposals"
    description = "Archive wrapper for new_proposals (pre-consolidation)"
