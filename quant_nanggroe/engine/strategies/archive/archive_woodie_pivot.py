"""Archive wrapper for woodie_pivot — restored from pre-consolidation."""
...
class ArchiveWoodiePivotStrategy(Strategy):
    """Archive wrapper for woodie_pivot strategy (pre-consolidation)."""

    name = "archive_woodie_pivot"
    description = "Archive wrapper for woodie_pivot (pre-consolidation)"
