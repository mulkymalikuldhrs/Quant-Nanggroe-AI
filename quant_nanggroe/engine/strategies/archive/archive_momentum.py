"""Archive wrapper for momentum — restored from pre-consolidation."""
...
class ArchiveMomentumStrategy(Strategy):
    """Archive wrapper for momentum strategy (pre-consolidation)."""

    name = "archive_momentum"
    description = "Archive wrapper for momentum (pre-consolidation)"
