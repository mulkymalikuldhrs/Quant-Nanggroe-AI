"""Archive wrapper for support_resistance_strategy — restored from pre-consolidation."""
...
class ArchiveSupportResistanceStrategyStrategy(Strategy):
    ...
    description = "Archive wrapper for support_resistance_strategy (pre-consolidation)"
