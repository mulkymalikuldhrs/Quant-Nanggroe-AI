"""Archive wrapper for piercing_line — restored from pre-consolidation."""
...
class ArchivePiercingLineStrategy(Strategy):
    """Archive wrapper for piercing_line strategy (pre-consolidation)."""

    name = "archive_piercing_line"
    description = "Archive wrapper for piercing_line (pre-consolidation)"
