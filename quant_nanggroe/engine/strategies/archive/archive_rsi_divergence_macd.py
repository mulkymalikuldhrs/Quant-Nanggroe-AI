"""Archive wrapper for rsi_divergence_macd — restored from pre-consolidation."""
...
class ArchiveRsiDivergenceMacdStrategy(Strategy):
    """Archive wrapper for rsi_divergence_macd strategy (pre-consolidation)."""

    name = "archive_rsi_divergence_macd"
    description = "Archive wrapper for rsi_divergence_macd (pre-consolidation)"
