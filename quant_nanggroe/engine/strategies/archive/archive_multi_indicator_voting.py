"""Archive wrapper for multi_indicator_voting — restored from pre-consolidation."""
...
class ArchiveMultiIndicatorVotingStrategy(Strategy):
    """Archive wrapper for multi_indicator_voting strategy (pre-consolidation)."""

    name = "archive_multi_indicator_voting"
    description = "Archive wrapper for multi_indicator_voting (pre-consolidation)"
