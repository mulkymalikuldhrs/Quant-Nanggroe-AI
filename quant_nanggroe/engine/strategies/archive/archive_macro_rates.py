"""Archive wrapper for macro_rates — restored from pre-consolidation."""
...
class ArchiveMacroRatesStrategy(Strategy):
    """Archive wrapper for macro_rates strategy (pre-consolidation)."""

    name = "archive_macro_rates"
    description = "Archive wrapper for macro_rates (pre-consolidation)"
