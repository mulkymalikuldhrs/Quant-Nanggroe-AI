"""Archive wrapper for pairs_trading — restored from pre-consolidation."""
...
class ArchivePairsTradingStrategy(Strategy):
    """Archive wrapper for pairs_trading strategy (pre-consolidation)."""

    name = "archive_pairs_trading"
    description = "Archive wrapper for pairs_trading (pre-consolidation)"
