"""Archive wrapper for morning_star — restored from pre-consolidation."""
...
class ArchiveMorningStarStrategy(Strategy):
    """Archive wrapper for morning_star strategy (pre-consolidation)."""

    name = "archive_morning_star"
    description = "Archive wrapper for morning_star (pre-consolidation)"
