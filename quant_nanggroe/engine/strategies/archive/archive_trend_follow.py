"""Archive wrapper for trend_follow — restored from pre-consolidation."""
...
class ArchiveTrendFollowStrategy(Strategy):
    """Archive wrapper for trend_follow strategy (pre-consolidation)."""

    name = "archive_trend_follow"
    description = "Archive wrapper for trend_follow (pre-consolidation)"
