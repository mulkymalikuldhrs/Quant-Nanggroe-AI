"""Archive wrapper for three_white_soldiers — restored from pre-consolidation."""
...
class ArchiveThreeWhiteSoldiersStrategy(Strategy):
    """Archive wrapper for three_white_soldiers strategy (pre-consolidation)."""

    name = "archive_three_white_soldiers"
    description = "Archive wrapper for three_white_soldiers (pre-consolidation)"
