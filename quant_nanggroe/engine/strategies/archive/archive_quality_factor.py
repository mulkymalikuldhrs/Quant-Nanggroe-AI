"""Archive wrapper for quality_factor — restored from pre-consolidation."""
...
class ArchiveQualityFactorStrategy(Strategy):
    """Archive wrapper for quality_factor strategy (pre-consolidation)."""

    name = "archive_quality_factor"
    description = "Archive wrapper for quality_factor (pre-consolidation)"
