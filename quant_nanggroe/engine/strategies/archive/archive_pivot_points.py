"""Archive wrapper for pivot_points — restored from pre-consolidation."""
...
class ArchivePivotPointsStrategy(Strategy):
    """Archive wrapper for pivot_points strategy (pre-consolidation)."""

    name = "archive_pivot_points"
    description = "Archive wrapper for pivot_points (pre-consolidation)"
