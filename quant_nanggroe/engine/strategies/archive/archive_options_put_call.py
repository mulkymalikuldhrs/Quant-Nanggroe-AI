"""Archive wrapper for options_put_call — restored from pre-consolidation."""
...
class ArchiveOptionsPutCallStrategy(Strategy):
    """Archive wrapper for options_put_call strategy (pre-consolidation)."""

    name = "archive_options_put_call"
    description = "Archive wrapper for options_put_call (pre-consolidation)"
