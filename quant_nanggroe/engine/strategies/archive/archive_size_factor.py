"""Archive wrapper for size_factor — restored from pre-consolidation."""
...
class ArchiveSizeFactorStrategy(Strategy):
    """Archive wrapper for size_factor strategy (pre-consolidation)."""

    name = "archive_size_factor"
    description = "Archive wrapper for size_factor (pre-consolidation)"
