"""Archive wrapper for stat_arb_zscore — restored from pre-consolidation."""
...
class ArchiveStatArbZscoreStrategy(Strategy):
    """Archive wrapper for stat_arb_zscore strategy (pre-consolidation)."""

    name = "archive_stat_arb_zscore"
    description = "Archive wrapper for stat_arb_zscore (pre-consolidation)"
