"""Archive wrapper for risk_parity — restored from pre-consolidation."""
...
class ArchiveRiskParityStrategy(Strategy):
    """Archive wrapper for risk_parity strategy (pre-consolidation)."""

    name = "archive_risk_parity"
    description = "Archive wrapper for risk_parity (pre-consolidation)"
