"""Archive wrapper for three_black_crows — restored from pre-consolidation."""
...
class ArchiveThreeBlackCrowsStrategy(Strategy):
    """Archive wrapper for three_black_crows strategy (pre-consolidation)."""

    name = "archive_three_black_crows"
    description = "Archive wrapper for three_black_crows (pre-consolidation)"
