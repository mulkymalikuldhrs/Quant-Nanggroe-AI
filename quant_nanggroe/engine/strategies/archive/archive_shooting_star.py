"""Archive wrapper for shooting_star — restored from pre-consolidation."""
...
class ArchiveShootingStarStrategy(Strategy):
    """Archive wrapper for shooting_star strategy (pre-consolidation)."""

    name = "archive_shooting_star"
    description = "Archive wrapper for shooting_star (pre-consolidation)"
