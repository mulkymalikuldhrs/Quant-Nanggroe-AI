"""Archive wrapper for trend_following_cta — restored from pre-consolidation."""
...
class ArchiveTrendFollowingCtaStrategy(Strategy):
    """Archive wrapper for trend_following_cta strategy (pre-consolidation)."""

    name = "archive_trend_following_cta"
    description = "Archive wrapper for trend_following_cta (pre-consolidation)"
