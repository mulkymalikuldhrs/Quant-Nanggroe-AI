"""Archive wrapper for yield_curve — restored from pre-consolidation."""
...
class ArchiveYieldCurveStrategy(Strategy):
    """Archive wrapper for yield_curve strategy (pre-consolidation)."""

    name = "archive_yield_curve"
    description = "Archive wrapper for yield_curve (pre-consolidation)"
