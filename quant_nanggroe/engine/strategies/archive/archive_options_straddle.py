"""Archive wrapper for options_straddle — restored from pre-consolidation."""
...
class ArchiveOptionsStraddleStrategy(Strategy):
    """Archive wrapper for options_straddle strategy (pre-consolidation)."""

    name = "archive_options_straddle"
    description = "Archive wrapper for options_straddle (pre-consolidation)"
