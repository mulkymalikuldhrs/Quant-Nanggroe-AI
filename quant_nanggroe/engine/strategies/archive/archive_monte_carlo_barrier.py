"""Archive wrapper for monte_carlo_barrier — restored from pre-consolidation."""
...
class ArchiveMonteCarloBarrierStrategy(Strategy):
    """Archive wrapper for monte_carlo_barrier strategy (pre-consolidation)."""

    name = "archive_monte_carlo_barrier"
    description = "Archive wrapper for monte_carlo_barrier (pre-consolidation)"
