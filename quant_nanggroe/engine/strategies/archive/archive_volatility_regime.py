"""Archive wrapper for volatility_regime — restored from pre-consolidation."""
...
class ArchiveVolatilityRegimeStrategy(Strategy):
    """Archive wrapper for volatility_regime strategy (pre-consolidation)."""

    name = "archive_volatility_regime"
    description = "Archive wrapper for volatility_regime (pre-consolidation)"
