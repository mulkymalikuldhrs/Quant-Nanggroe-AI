"""Archive wrapper for regime_hmm — restored from pre-consolidation."""
...
class ArchiveRegimeHmmStrategy(Strategy):
    """Archive wrapper for regime_hmm strategy (pre-consolidation)."""

    name = "archive_regime_hmm"
    description = "Archive wrapper for regime_hmm (pre-consolidation)"
