"""Archive wrapper for momentum_factor — restored from pre-consolidation."""
...
class ArchiveMomentumFactorStrategy(Strategy):
    """Archive wrapper for momentum_factor strategy (pre-consolidation)."""

    name = "archive_momentum_factor"
    description = "Archive wrapper for momentum_factor (pre-consolidation)"
