"""Archive wrapper for williams_r — restored from pre-consolidation."""
...
class ArchiveWilliamsRStrategy(Strategy):
    """Archive wrapper for williams_r strategy (pre-consolidation)."""

    name = "archive_williams_r"
    description = "Archive wrapper for williams_r (pre-consolidation)"
