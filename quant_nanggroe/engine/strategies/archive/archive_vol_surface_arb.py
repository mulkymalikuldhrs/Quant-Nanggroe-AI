"""Archive wrapper for vol_surface_arb — restored from pre-consolidation."""
...
class ArchiveVolSurfaceArbStrategy(Strategy):
    """Archive wrapper for vol_surface_arb strategy (pre-consolidation)."""

    name = "archive_vol_surface_arb"
    description = "Archive wrapper for vol_surface_arb (pre-consolidation)"
