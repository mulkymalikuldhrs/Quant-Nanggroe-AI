"""Archive wrapper for volatility_selling — restored from pre-consolidation."""
...
class ArchiveVolatilitySellingStrategy(Strategy):
    """Archive wrapper for volatility_selling strategy (pre-consolidation)."""

    name = "archive_volatility_selling"
    description = "Archive wrapper for volatility_selling (pre-consolidation)"
