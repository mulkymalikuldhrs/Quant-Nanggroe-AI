"""Archive wrapper for on_chain_momentum — restored from pre-consolidation."""
...
class ArchiveOnChainMomentumStrategy(Strategy):
    """Archive wrapper for on_chain_momentum strategy (pre-consolidation)."""

    name = "archive_on_chain_momentum"
    description = "Archive wrapper for on_chain_momentum (pre-consolidation)"
