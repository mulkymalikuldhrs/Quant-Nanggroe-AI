"""Archive wrapper for parabolic_sar — restored from pre-consolidation."""
...
class ArchiveParabolicSarStrategy(Strategy):
    """Archive wrapper for parabolic_sar strategy (pre-consolidation)."""

    name = "archive_parabolic_sar"
    description = "Archive wrapper for parabolic_sar (pre-consolidation)"
