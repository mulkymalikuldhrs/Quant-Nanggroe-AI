"""Archive wrapper for relative_vigor — restored from pre-consolidation."""
...
class ArchiveRelativeVigorStrategy(Strategy):
    """Archive wrapper for relative_vigor strategy (pre-consolidation)."""

    name = "archive_relative_vigor"
    description = "Archive wrapper for relative_vigor (pre-consolidation)"
