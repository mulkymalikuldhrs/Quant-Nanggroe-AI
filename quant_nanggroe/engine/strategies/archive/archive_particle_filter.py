"""Archive wrapper for particle_filter — restored from pre-consolidation."""
...
class ArchiveParticleFilterStrategy(Strategy):
    """Archive wrapper for particle_filter strategy (pre-consolidation)."""

    name = "archive_particle_filter"
    description = "Archive wrapper for particle_filter (pre-consolidation)"
