"""Archive wrapper for pairs_cointegration — restored from pre-consolidation."""
...
class ArchivePairsCointegrationStrategy(Strategy):
    """Archive wrapper for pairs_cointegration strategy (pre-consolidation)."""

    name = "archive_pairs_cointegration"
    description = "Archive wrapper for pairs_cointegration (pre-consolidation)"
