...
class TestAgentRegistry:
    ...
    def setup_method(self):
        ...
        AgentRegistry.get_default().clear()
    ...
    def test_register_agent(self):
        ...
        assert "test_registered" in AgentRegistry.get_default().list_agents()
    ...
    def test_get_agent(self):
        ...
        factory = AgentRegistry.get_default().get("test_get")
        assert factory is not None
        assert factory == TestGet

    def test_get_nonexistent_agent(self):
        """Should return None for unregistered agent."""
        result = AgentRegistry.get_default().get("nonexistent")
    ...
    def test_get_by_role(self):
        ...
        factory = AgentRegistry.get_default().get_by_role(AgentRole.STRATEGIST)
        assert factory is not None
    ...
    def test_list_agents(self):
        ...
        agents = AgentRegistry.get_default().list_agents()
    ...
    def test_clear(self):
        ...
        AgentRegistry.get_default().clear()
        assert len(AgentRegistry.get_default().list_agents()) == 0
