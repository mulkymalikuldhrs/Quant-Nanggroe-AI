...
Quick Start:
    # Server side
    from quant_nanggroe_ai.mcp import MCPServer, register_all_trading_tools

    server = MCPServer(name="quant-nanggroe", version="0.2.0")
    register_all_trading_tools(server)

    # Client side
    from quant_nanggroe_ai.mcp import LocalMCPClient
...
from quant_nanggroe_ai.mcp.server import (
    FunctionToolHandler,
    MCPServer,
    ToolHandler,
)
from quant_nanggroe_ai.mcp.tools import (
    BACKTEST_RUN,
...
from quant_nanggroe_ai.mcp.client import (
    ConnectionState,
    LocalMCPClient,
    MCPClient,
    ServerConnection,
