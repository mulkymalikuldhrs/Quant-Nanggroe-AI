...
from quant_nanggroe_ai.exchange.base import ExchangeConfig, ExchangeInterface
...
class ExchangeFactory:
    ...
    def create(
        ...
        *,
        ...
        Returns:
            An :class:`~quant_nanggroe_ai.exchange.base.ExchangeInterface` instance.
    ...
    def _create_paper_broker(
        ...
        Returns:
            A :class:`~quant_nanggroe_ai.exchange.paper_broker.PaperExchangeBroker`.
        """
