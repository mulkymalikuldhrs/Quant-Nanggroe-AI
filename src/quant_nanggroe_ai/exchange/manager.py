...
Manages multiple :class:`~quant_nanggroe_ai.exchange.base.ExchangeInterface`
...
from quant_nanggroe_ai.types.market import OHLCV, OrderBook, Ticker, TimeFrame
from quant_nanggroe_ai.types.orders import Order, OrderSide, OrderStatus, OrderType
from quant_nanggroe_ai.types.positions import Position, Portfolio
...
class ExchangeManager:
    ...
    async def get_aggregated_portfolio(self) -> Portfolio:
        ...
        Returns:
            A single :class:`~quant_nanggroe_ai.types.positions.Portfolio` with
