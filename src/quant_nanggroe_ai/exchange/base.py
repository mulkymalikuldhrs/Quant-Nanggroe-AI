...
from quant_nanggroe_ai.types.market import OHLCV, Ticker, OrderBook, TimeFrame
from quant_nanggroe_ai.types.orders import Order, OrderSide, OrderType, OrderStatus
...
class ExchangeInterface(ABC):
    ...
    * Methods return Pydantic models from ``quant_nanggroe_ai.types``.
    ...
    * Rate limiting and retries are built into implementations, not the caller.
    ...
    async def get_positions(self) -> List[Position]:
        ...
        Returns:
            List of :class:`~quant_nanggroe_ai.types.positions.Position` instances.
        """
    ...
    async def get_portfolio(self) -> Portfolio:
        ...
        Returns:
            :class:`~quant_nanggroe_ai.types.positions.Portfolio` with positions,
    ...
    async def place_order(
        ...
        Returns:
            The submitted :class:`~quant_nanggroe_ai.types.orders.Order` with
    ...
    async def cancel_order(self, order_id: str, symbol: Optional[str] = None) -> Order:
        ...
        Returns:
            The cancelled :class:`~quant_nanggroe_ai.types.orders.Order`.
    ...
    async def get_order(self, order_id: str, symbol: Optional[str] = None) -> Order:
        ...
        Returns:
            The current :class:`~quant_nanggroe_ai.types.orders.Order` state.
    ...
    async def get_ohlcv(
        ...
        Returns:
            List of :class:`~quant_nanggroe_ai.types.market.OHLCV` candles.
    ...
    async def get_ticker(self, symbol: str) -> Ticker:
        ...
        Returns:
            :class:`~quant_nanggroe_ai.types.market.Ticker` snapshot.
    ...
    async def get_orderbook(self, symbol: str, limit: int = 20) -> OrderBook:
        ...
        Returns:
            :class:`~quant_nanggroe_ai.types.market.OrderBook` snapshot.
