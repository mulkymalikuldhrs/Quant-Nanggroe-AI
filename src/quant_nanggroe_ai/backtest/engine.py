    ...
    def _check_stops(
        ...
        for symbol, pos in positions.items():
            ...
            if pos.stop_loss is not None:
                if pos.side == "LONG" and current_low <= pos.stop_loss:
                    exit_price = pos.stop_loss
                    exit_triggered = True
                    exit_reason = "stop_loss"
                elif pos.side == "SHORT" and current_high >= pos.stop_loss:
                    exit_price = pos.stop_loss
                    exit_triggered = True
                    exit_reason = "stop_loss"
            ...
            if not exit_triggered and pos.take_profit is not None:
                if pos.side == "LONG" and current_high >= pos.take_profit:
                    exit_price = pos.take_profit
                    exit_triggered = True
                    exit_reason = "take_profit"
                elif pos.side == "SHORT" and current_low <= pos.take_profit:
                    exit_price = pos.take_profit
                    exit_triggered = True
                    exit_reason = "take_profit"
