...
- numpy 2.5.1 ✅, pytests 173+ ✅, MT5 live ✅
...
ruff check quant_nanggroe/        # Lint
uv sync                           # Package install
.venv/Scripts/python -m pytest tests/ -v  # Tests
```

## Architecture
- **Pipeline:** `hedge_fund/portfolio/main.py` — 7-stage
- **Scoring:** `core/scoring/` — 8 scorers + FusionEngine + MTF
- **Evolution:** `engine/evolution/` — 8 files (🔴 BROKEN)
- **Agents:** `agents/` — 16 agents, 13 functional
- **Infra:** `engine/risk/`, `engine/execution/`, `exchange/`
