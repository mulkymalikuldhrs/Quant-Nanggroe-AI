...
- 83 strategies in `quant_nanggroe/engine/strategies/` via `@StrategyRegistry.register` (v8.0.21 CANONICAL SSOT — 9 admitted via CPCV, 207 WF-validated in walk_forward_registry.json)
...
- **SSOT:** `CANONICAL.md` v8.0.21 — BAL 1445, weekly 0 WIB, probe 0/32, CPCV 207, launch.bat 1, manager.py WIB
