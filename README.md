...
**Status:** LIVE on MT5 — CANONICAL v8.0.19 | **Broker:** ValetaxIntl-Live2 (login 372044706 QNA, BAL $1,445) | **Account:** QNA | **Weekly:** 0 WIB | **Probe:** 0/32 | **CPCV:** 207 | **Launcher:** `launch.bat` (single, WIB) | **Risk:** `engine/execution/manager.py` WIB weekly/PNL guard — see `CANONICAL.md` SSOT
