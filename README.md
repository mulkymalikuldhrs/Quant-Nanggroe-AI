# Quant Nanggroe AI v8.0.3 — Autonomous Quant Hedge Fund
...
- `CANONICAL.md` — Single Source of Truth (v8.0.3)
...
**Version:** v8.0.3 | **Status:** GREEN — LIVE on MT5 | **Broker:** ValetaxIntl-Live2 (Cent, .vxc)
